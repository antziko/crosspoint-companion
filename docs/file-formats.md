...
offset rather than a page number. The other section LUTs are unchanged. The
partial-build watermark trailer now follows the visible-text LUT rather than the
list-item LUT.
